...
/*
 * Copyright 2014-2017 Sebastian Dohm
 * 
...
// REPLACE OUTER GRAPHITE C ATOMS WITH H ATOMS VIA INSERTING ADDITIONAL ATOMS
  ...
  ->double
  {
    ...
    std::vector< std::vector<double> >nOldVelocities;
    ...
    for(const auto& atom:nAtoms_)
    {
      ...
      nOldVelocities.push_back(velocity);
    ...
    for(const auto& atomNo:nAtomNos_)
    {
      ...
      (
        atomNo                                                          ,
        xCoordinate +
         ((nVelocities[atomNo - 1][0] + nOldVelocities[atomNo - 1][0]) *
          timeFrame_ / 2)                                               ,
        yCoordinate +
         ((nVelocities[atomNo - 1][1] + nOldVelocities[atomNo - 1][1]) *
          timeFrame_ / 2)                                               ,
        zCoordinate +
         ((nVelocities[atomNo - 1][2] + nOldVelocities[atomNo - 1][2]) *
          timeFrame_ / 2)
      );
